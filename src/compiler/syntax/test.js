...
/*
  ...
  print(String.raw`5_00..>>>>>>>>>>>>>>>>>>>>>>>>MID`); // mid
  print(new Parser('5_00..').parseFloatLiteral()); // mid
  ...
  print(String.raw`5_00.`);
  print(new Parser('5_00.').parseFloatLiteral());

  print(String.raw`0b110.`);
  print(new Parser('0b110.').parseFloatLiteral());

  print(String.raw`0o657.`);
  print(new Parser('0o657.').parseFloatLiteral());

  print(String.raw`0x6e5_7ff.`);
  print(new Parser('0x6e5_7ff.').parseFloatLiteral());
  ...
  // print(new Parser("|name| => 25").parseCommandNotationPostfix());
  ...
  print(new Parser("(5.).name").parseAtom());
  ...
  print(String.raw`0b110.`);
  print(new Parser('0b110.').parsePostfixAtom());
  ...
  print(String.raw`0o657.`);
  print(new Parser('0o657.').parsePrepostfixAtom());
  ...
  print(String.raw`[234., /regex/.age, {x, y}]`);
  print(new Parser('[234., /regex/.age, {x, y}]').parsePrepostfixAtom());
  ...
  print(new Parser("'hi'+/d/").parseInfixExpression());

  print(String.raw`+/d/`);
  print(new Parser("+/d/").parseInfixExpression());

  print('========= INFIXEXPRESSIONORRANGE =========');

  print(String.raw`45..>>>>>>>>>>>>>>>>>>>>>>>>MID`); // mid
  print(new Parser("45..").parseInfixExpressionOrRange()); // mid

  print(String.raw`1-..'hi'+/d/`);
  print(new Parser("1-..'hi'+/d/").parseInfixExpressionOrRange());

  print(String.raw`..name..'hi'`);
  print(new Parser("..name..'hi'").parseInfixExpressionOrRange());

  print(String.raw`'hi'+/d/`);
  print(new Parser("'hi'+/d/").parseInfixExpressionOrRange());

  print(String.raw`+/d/`);
  print(new Parser("+/d/").parseInfixExpressionOrRange());
*/
